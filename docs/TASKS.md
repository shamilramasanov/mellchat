...
**Задача:** Оптимизировать интерфейс для мобильных устройств, особенно для PWA установленных на рабочий стол. Сделать интерфейс удобным и функциональным на мобильных устройствах.

**Текущее поведение:**
- Шапка уходит под "челку" iPhone (safe area не учитывается)
...
**Требуемое поведение:**
- Шапка должна учитывать safe area iPhone (не уходить под "челку")
- Подвал должен быть закреплен в самом низу экрана
...
- Правильная работа на полноэкранном режиме PWA
...
- Добавить padding-top для шапки с учетом safe-area-inset-top
...
- Проверить работу на разных размерах экранов (iPhone, Android)
- Убедиться, что интерфейс работает в полноэкранном режиме PWA
