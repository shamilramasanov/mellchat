...
- **Компактный дизайн** - элементы должны быть более компактными, не занимать много места
- **Цветовое оформление** - пересмотреть цветовую палитру, сделать более приятной и гармоничной (не использовать стандартные яркие Material Design цвета)
- **Компактный дизайн** - элементы должны быть более компактными, не занимать много места
- **Цветовое оформление** - пересмотреть цветовую палитру, сделать более приятной и гармоничной
