...
### 7. Создание отдельного проекта с новым UI дизайном

**Задача:** Создать отдельный проект с новым UI дизайном, разработанным с нуля, как аналог текущего интерфейса MellChat, но с собственным подходом к дизайну и визуальному стилю.
...
- Сохранить весь существующий функционал MellChat, но с новым визуальным дизайном
- Учесть все основные компоненты: шапка, карточки стримов, чат, сообщения, настройки
- Применить собственный подход к дизайну стеклянных эффектов, цветовой схеме, типографике
...
- React компоненты с новым дизайном
- CSS/стили с новым подходом к визуализации
- Демо данные для отображения функционала

**Детали реализации:**
- Использовать React 18 и Vite (как в основном проекте)
- Создать все основные компоненты:
  - Header/Navigation
  - Stream Cards (карточки стримов)
  - Chat Container (контейнер чата)
  - Message Cards (карточки сообщений)
  - Settings Panel (панель настроек)
  - Recent Streams (последние стримы)
  - Add Stream Modal (модальное окно добавления стрима)
- Применить новый визуальный стиль:
  - Альтернативный подход к glassmorphism
  - Новая цветовая палитра
  - Обновленная типографика
  - Другие эффекты и переходы
- Использовать моковые данные для демонстрации всех состояний
- Учесть все интерактивные элементы:
  - Кнопки, счетчики, фильтры
  - Поиск, навигация
...
- Создать демо-страницу с примерами всех компонентов

**Цель:**
- Позволить оценить альтернативный подход к UI дизайну
- Не затрагивать существующий проект MellChat
- Сохранить весь функционал визуально для понимания возможностей
