  ...
  return (
    <div className="h-full flex flex-col items-center justify-center px-6 py-12 bg-white">
      <div className="w-full max-w-md text-center">
        <h1 className="mb-4 text-[48px] text-black">{t('newui.welcomeTitle')}</h1>
        <p className="mb-8 text-gray-600">{t('newui.welcomeSubtitle')}</p>
        ...
        <button onClick={onGetStarted} className="inline-flex items-center justify-center gap-2 px-6 py-3 border border-gray-300 rounded-lg bg-white text-black text-base font-medium cursor-pointer transition-all hover:bg-gray-50 hover:border-gray-400 hover:-translate-y-0.5 hover:shadow-md active:translate-y-0 active:shadow-sm min-h-[44px]">
          {t('newui.getStarted')}
        </button>
      </div>
    </div>
