...
### **A4. Улучшение производительности** ⚡
**Приоритет**: Средний  
**Статус**: 🟡 В планах  
...
6. 🔲 **TTS озвучивание** - базовая версия (Browser API)
7. 🔲 **Оптимизация производительности** - виртуализация списков
8. 🔲 **Тестирование** - юнит + интеграционные тесты
9. 🔲 **Документация** - API docs + User guide
10. 🔲 **Marketing** - первые пользователи из Reddit/Twitter
...
*Этот план живой и будет обновляться каждый месяц*
